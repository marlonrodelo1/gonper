...
// ============================================================
// TIENDA B2C — ELIMINADA (sesión 2026-05-18, pivote a Farmasi MLM)
// Las funciones getVentasB2cRecientes, getTotalVentasB2c,
// getProductosActivosTienda, getProductosDisponiblesMarca,
// activarProductoTienda y desactivarProductoTienda se retiraron junto
// con el sistema B2B2C. Ahora cada salón gestiona su tienda Farmasi
// directamente en farmasi.es bajo su cuenta BI.
// ============================================================
