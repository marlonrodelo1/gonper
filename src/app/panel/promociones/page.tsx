    ...
    <div className="flex flex-col gap-6 px-4 py-6 md:px-8">
      ...
      {filas.length === 0 ? (
        ...
        <div className="card overflow-hidden">
          <div className="grid grid-cols-[100px_1fr_120px_140px_120px_110px_220px] items-center gap-3 border-b border-line bg-cream/40 px-5 py-3 text-[10px] uppercase tracking-[0.2em] text-stone/70">
            <div>Tag</div>
            <div>Título</div>
            <div>Descuento</div>
