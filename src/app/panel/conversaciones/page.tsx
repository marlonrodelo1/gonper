    ...
    <div className="flex flex-col gap-6 px-4 py-6 md:px-8">
      ...
      {todas.length === 0 ? (
        ...
        <div className="card overflow-hidden">
          <div className="grid grid-cols-[44px_1fr_120px_100px_60px] items-center gap-3 border-b border-line bg-cream/40 px-5 py-3 text-[10px] uppercase tracking-[0.2em] text-stone/70">
            <div />
