...
const STEPS: Step[] = [
  {
    ...
    cuerpo:
      '7 días gratis. Hoy 0 € y puedes cancelar antes de que acabe el trial sin coste. Vamos a darte un tour rápido por el panel.',
  },
  {
  ...
  },
  {
    ...
    titulo: 'A trabajar 💪',
    cuerpo:
      'Si necesitas ayuda escríbenos a hola@gonperstudio.shop. Cuando termine tu prueba de 7 días pasarás automáticamente al plan Básico (30 €/mes), salvo que canceles antes.',
  },
];
