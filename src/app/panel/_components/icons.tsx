...
export const Icon = {
  ...
  Tg: (p: IconProps) => (
    <svg viewBox="0 0 24 24" fill="currentColor" {...p}>
      <path d="M21.5 4.5L18.4 19.2c-.2 1-.9 1.3-1.8.8l-5-3.7-2.4 2.3c-.3.3-.5.5-1 .5l.4-5.1L18 6.4c.4-.4-.1-.6-.6-.2L7.5 12.6 3.4 11.3c-.9-.3-.9-.9.2-1.3L20.4 3.4c.7-.3 1.4.2 1.1 1.1z" />
    </svg>
  ),
  Phone: (p: IconProps) => (
    <svg
