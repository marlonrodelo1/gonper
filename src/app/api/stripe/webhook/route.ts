...
export async function POST(req: Request) {
  ...
  try {
    switch (event.type) {
      ...
      // Handlers eliminados (sesión 2026-05-18): account.updated (Stripe Connect)
      // y payment_intent.succeeded (ventas B2C). Ahora cada salón es BI Farmasi
      // independiente: las ventas se cobran directo en farmasi.es bajo su cuenta.
    }
  } catch (err) {
