...
export const alt = 'Gonper Studio — Lleva tu negocio desde tu móvil';
export const size = { width: 1200, height: 630 };
export const contentType = 'image/png';

// Imagen Open Graph minimalista que imita el logo de marca: fondo
// cream, "Gonper Studio" en serif gigante color stone/violeta y slogan corto
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* Gonper Studio + estrellas decorativas en la misma línea */}
        <div
          style={{
            display: 'flex',
            alignItems: 'center',
