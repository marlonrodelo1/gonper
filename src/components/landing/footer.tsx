...
const cols: Array<[string, string[]]> = [
  ...
  ["Empresa", ["Sobre Gonper Studio", "Privacidad", "Términos", "Contacto"]],
];
    ...
    <footer className="border-t border-line bg-paper">
      <div className="mx-auto max-w-[1200px] px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10">
          <div className="col-span-2">
            <div className="flex items-center gap-2 text-ink mb-4">
              ...
              <span className="text-[18px] tight font-medium">Gonper Studio</span>
            </div>
            <p className="text-stone text-[14px] max-w-[280px] leading-relaxed">
              Un asistente que nunca descansa. Para barberías, peluquerías, centros de uñas y de estética en España.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-[13px] text-stone">
          <p>© 2026 Gonper Studio · Tenerife, España · Hecho con cariño en Canarias 🌊</p>
