...
const cols: Array<[string, string[]]> = [
  ...
  ["Empresa", ["Sobre Gestori", "Privacidad", "Términos", "Contacto"]],
];
    ...
    <footer className="border-t border-line bg-paper">
      <div className="mx-auto max-w-[1200px] px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10">
          <div className="col-span-2">
            <div className="flex items-center gap-2 text-ink mb-4">
              ...
              <span className="text-[18px] tight font-medium">Gestori</span>
            </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-[13px] text-stone">
          <p>© 2026 Gestori · Tenerife, España · Hecho con cariño en Canarias 🌊</p>
